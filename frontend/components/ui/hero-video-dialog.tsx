      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 rounded-full bg-[#11182780] p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-[#F3F4F680] dark:text-black">
