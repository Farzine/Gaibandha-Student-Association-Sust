                ...
                <form>
                  ...
                  <div className="mb-8">
                    ...
                    <select
                      ...
                      className="border-stroke dark:text-body-color-dark dark:shadow-two w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none"
                    >
                        <option value="" className="dark:text-white dark:shadow-two dark:border-transparent dark:bg-[#5C7AF8] bg-[#5C7AF8] text-white" disabled selected>Select your department</option>
                        ...
                        <option value="Geography & Environment">16. Geography & Environment</option>
                        ...
                        <option value="Petroleum & Georesources Engineering">19. Petroleum & Georesources Engineering</option>
                  ...
                  <div className="mb-8">
                    ...
                    <select
                      ...
                      className="border-stroke dark:text-body-color-dark dark:shadow-two w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none"
                    >
                      <option value="" className="dark:text-white dark:shadow-two dark:border-transparent dark:bg-[#5C7AF8] bg-[#5C7AF8] text-white" disabled selected>Select your blood group</option>
                  ...
                  <div className="mb-8">
                    ...
                    <select
                      ...
                      className="border-stroke dark:text-body-color-dark dark:shadow-two w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none"
                    >
                      <option value="" className="dark:text-white dark:shadow-two dark:border-transparent dark:bg-[#5C7AF8] bg-[#5C7AF8] text-white" disabled selected>Select your religious status</option>
