...
const SignupPage = () => {
  ...
  return (
    ...
    <Breadcrumb pageName="Signup" />
      <section className="min-h-screen px-4 mb-20">
      <div className="container mx-auto">
        ...
        <div className="w-full max-w-md lg:max-w-xl">
          ...
          <div className="px-6 py-8 sm:px-8 md:px-10">
            ...
            {/* Error/Success Messages as Toasts */}
            <div className="flex items-center justify-center pointer-events-none z-50">
              ...
              {showError && errorMessage && (
                ...
                className="mb-4 rounded-lg border border-danger bg-[#FEF2F2] p-4 text-[#F87171] dark:border-danger dark:bg-[#1F2937] dark:text-[#F87171] shadow-lg transform transition-all duration-300 animate-fadeIn"
                role="alert"
                >
                ...
                <div className="flex">
                  ...
                  className="pointer-events-auto rounded-lg border border-[#CB8686] bg-transparent px-3 py-1.5 text-center text-xs font-medium text-[#991B3E] hover:bg-[#991B3E] hover:text-white focus:outline-none focus:ring-4 focus:ring-[#FCA5A5] dark:border-[#7E282F] dark:text-[#EF4443] dark:hover:bg-[#DC2626] dark:hover:text-white dark:focus:ring-[#991B1B]"
                  >
                  Dismiss
                  </button>
                </div>
              ...
              {showSuccess && successMessage && (
                ...
                className="mb-4 rounded-lg border border-[#065F46] bg-[#ECFDF5] p-4 text-[#065F46] dark:border-[#065F46] dark:bg-[#1F2937] dark:text-[#34D399] shadow-lg transform transition-all duration-300 animate-fadeIn"
                role="alert"
                >
                <div className="flex items-center">
                  <svg
                ...
                <div className="flex">
                  ...
                  className="pointer-events-auto rounded-lg border border-[#ADF2D6] bg-transparent px-3 py-1.5 text-center text-xs font-medium text-[#065F46] hover:bg-[#065F46] hover:text-white focus:outline-none focus:ring-4 focus:ring-[#6EE7B7] dark:border-[#13443F] dark:text-[#34D399] dark:hover:bg-[#059669] dark:hover:text-white dark:focus:ring-[#065F46]"
                  >
                  Dismiss
                  </button>
                </div>
