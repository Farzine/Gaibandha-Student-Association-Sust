    ...
    <div className="relative">
      <Dock iconMagnification={60} iconDistance={100}>
        <DockIcon className="bg-black/10 dark:bg-white/10">
          <Link href="https://www.facebook.com/gaibandhastudentsassociationsust">
            <Icons.facebook className="size-full" />
          </Link>
        </DockIcon>
        <DockIcon className="bg-black/10 dark:bg-white/10">
          <Link href="https://drive.google.com/drive/folders/1RKhJHExIPoVqP2fd129xuCsvJSIz0EhI?usp=sharing">
            <Icons.googleDrive className="size-full" />
          </Link>
        </DockIcon>
        <DockIcon className="bg-black/10 dark:bg-white/10">
          <Link href="https://www.youtube.com/channel/UCcL5liz6k9DpkC9FPVqJuHQ">
            <Icons.youtube className="size-full" />
          </Link>
        </DockIcon>
        <DockIcon className="bg-black/10 dark:bg-white/10">
          <Link
            href="https://wa.me/01614823637"
            target="_blank"
